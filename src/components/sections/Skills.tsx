    ...
    <section id="skills" className="py-20 skills-section">
      <div className="container mx-auto px-4">
        <header className="mb-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-3 bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">
            Skills
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {skillsData.map((category) => (
            ...
            >
              <h3 className="font-semibold text-xl mb-4 text-primary border-b border-primary/30 pb-2">
